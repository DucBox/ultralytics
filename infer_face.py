...
model = YOLO('/Users/ngoquangduc/Desktop/workspace/face_detection/ultralytics/runs/face/train12/weights/best.pt', task='face')
...
# 2. Run Inference kèm tham số config (thêm conf=0.1 để filter các bbox có score quá thấp)
